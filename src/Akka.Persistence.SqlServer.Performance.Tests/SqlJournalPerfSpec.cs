...
namespace Akka.Persistence.SqlServer.Performance.Tests
{
    ...
    public abstract class SqlJournalPerfSpec : Akka.TestKit.Xunit2.TestKit
    {
        ...
        /// </summary>
        protected int MeasurementIterations = 500;

        /// <summary>
        /// Sigma value for the z-score outlier rejection algorithm
        /// </summary>
        protected double OutlierRejectionSigma = 3.0;
        ...
        protected SqlJournalPerfSpec(Config config, string actorSystem, ITestOutputHelper output)
